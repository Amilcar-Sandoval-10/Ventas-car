...
{
    public partial class Frm_Buscador_Inventario : Form
    {


        public Frm_Buscador_Inventario()
        {
            InitializeComponent();
        }
        ...
        public Frm_Buscador_Inventario(Frm_Compra parametro)
        {
            InitializeComponent();
        ...
        private void Frm_Buscador_Inventario_Load(object sender, EventArgs e)
        {
            CargarGrid();
        }
